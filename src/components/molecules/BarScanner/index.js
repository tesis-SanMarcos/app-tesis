...
import { Button, StyleSheet, Text, View, Linking, TouchableOpacity, Alert } from "react-native";
...
const WBarScanner = () => {
    ...
    const handleBarCodeScanned = ({ type, data }) => {
        ...
        callAudio()
        setTimeout(()=>{
            navigateHook.navigate(Routes.Products)
    ...
    if (hasPermission === null) {
        return (
            <View style={styles.container}><Text > Por favor, dar permisos a la cámara</Text></View>
        );
    }
    ...
    return (
        <View style={styles.container}>
            ...
            <Text style={styles.paragraph}>Pulsa el botón para iniciar el escaneo.</Text>
            { renderCamera()}
        </View>
    );
};
